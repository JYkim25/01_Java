...
양수가 아니면 “양수만 입력해주세요.”를 출력하세요.*/
	...
	*/
		...
		String result; // 결과 저장용 변수 선언 (나중에 사용하려면 초기화 필수)
	...
	public void practice5() {
		...
		*/
		...
		double a = midexam * 0.2;
		double b = finalexam * 0.3;
		double c = score * 0.3;
		double z = a+b+c+attendance;
		...
		*/
		...
		//int로 했다면 자동적으로 강제형변환 해줌
		finalTerm *= 0.3;
		report *= 0.3;
		
		System.out.println("================= 결과 =================");
		
		if(attendance <= 20 * 0.7) { // 출석 만족 못했을 때 (70% 이상 출석했는 지)
			// 총 강의 횟수 : 20
			// 결석 기준 : 0.3
