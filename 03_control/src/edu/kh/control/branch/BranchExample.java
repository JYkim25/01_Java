...
public class BranchExample {
	...
	public void ex4() {
		...
		// 단, 5의 배수는 건너뛰고
		// 증가하는 값이 40이 되었을 때 반복 멈춤 (반복문, 조건문, 분기문 다 필요)
	...
	public void RSPGame() { //메서드명은 소문자로 시작하는 것이 관례
		// 가위바위보 게임
		// 몇 판 할지 입력받음
		// 입력받은 판 수 만큼 반복
		...
		for(int i = 1; i <= round; i++) { // 입력받은 판 수 만큼 반복
			...
			String com = null; // 초기화 필요 (컴퓨터가 switch에서 default 의 경우가 있을거라 판단)
