...
public class ForExample { // 기능 제공용 클래스
	...
	public void ex1() {
		...
		for(int i = 1; i <= 10; i++) {
			// 수행될 코드 (반복 수행될 코드)
			System.out.println(i); // i 는 보통 index
		}
	...
	public void ex2() {
		...
		for(int i = 'A'; i <= 'Z'; i++) { // A 를 int로 자동형변환
			System.out.print((char)i); // char 로 강제형변환
		}
