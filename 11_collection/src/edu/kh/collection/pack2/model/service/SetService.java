...
public class SetService {
	...
	public void method2() {
		...
		for(String snack : set) { // 가장 간단한 방법
	...
	public void method3() {
		...
		// - 같은 필드 값을 가진 객체는 해쉬코드 번호가 같다!
		System.out.println("p1 : " + p1.hashCode());
		System.out.println("p2 : " + p2.hashCode());
		System.out.println("p3 : " + p3.hashCode());
		System.out.println("p4 : " + p4.hashCode());
		
		// A.equals(B) : A와 B가 가지고 있는 필드값이 전부 같다면 tru
	 ...
	 * -> 기본 오름차순 정렬
	 * 
	 * TreeSet 안에 저장되는 객체는 Copparable 인터페이스 상속 필수
	 * -> Integer 는 Camparable 상속 되어 있음
	 * 
	 */
	public void method4() {
	 ...
	 * </pre>
	 */
	public void lottoNumberGenerator() { //컬렉션 안에 컬렉션 넣기 가능
