...
public class MapService {
	...
	public void ex1() {
		...
		// key 중복 테스트
		map.put(1, "김정열"); // 중복 허용 X, 대신 Value 덮어쓰기
	...
	public void ex2() {
		...
		// 2) Map 버전 //(초기화 null 관련************10:07)
		Map<String, Object> map = new HashMap<String, Object>();
		// value가 Object 타입 == 어떤 객체들이라도 Value에 들어올 수 있다!
		...
		// Map에서 Key만 모아두면 Set의 특장을 가진다 (중복저장 X)
	...
	public void ex3() { //많이 이용하는 방법이므로 이해 필요***
		// List에 Map 여러개 추가하여 다루기
		
		List< Map<String, Object> > list = new ArrayList<Map<String, Object>>();
		// List 객체만 생성되었고, 해당 list에는 Map만 들어올 수 있음을 제한만 해둠
		// -> Map 객체는 아직 생성 X
		...
		// for문 종료시 list에 10개의 Map 객체가 추가되어 있다!
