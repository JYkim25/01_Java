...
public class PolyService {
	...
	public void ex1() {
		...
		// Tesla 객체를 참조하는 변수의 타입이 Car(부모)이기 때문
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		//car2.setBatteryCapacity(10000000); //car2 는 Tesla가 아닌 Car타입으로 인식되고 있음
	...
	public void printCar(Car temp) {
		// Car temp = temp = c(Car)
		// Car temp = temp = t(Tesla)자식 객체
		// Car temp = temp = s(Spark)자식 객체
		// 부모타입 참조변수 = 자식타입객체
		// -> 다형성의 업캐스팅 모양과 똑같다
	...
	public Car createCar(int num) {
		...
		Car result = null; //부모타입 객체에다 자식객체 넣는중
	...
	public void ex3() {
		...
		// 그래서 형변환하는 부분을 ()로 한번 더 묶어주고나서 연산을 진행해야
	...
	public void ex5() {
		...
		// -> "실행 시"에는 정적 바인딩보다 자식(Spark)에서 오버라이딩 된
