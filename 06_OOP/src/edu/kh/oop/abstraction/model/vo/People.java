...
public class People { // 국민(사람) 클래스
	...
	//추상화 된 필드들
	// [접근제한자] 자료형 변수명;
	private String name; //People이라는 클래스가 가진 name이라는 속성
	private char gender; // 노란 줄 : 경고
	...
	/*
	//접제 반환형 메서드명
	public String getName() { // getter setter 다 public 이어야 함 (외부 접근 가능)
		return name;
		// return : 반환, 되돌려주다
	...
	*/
	...
	public void setAge(int age) {
		...
		if(age >= 0) {
			...
			throw new IllegalArgumentException("양수만 됩니다");
		}
